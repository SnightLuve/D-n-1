...
public class SanPhamJDialog extends javax.swing.JDialog {
    ...
    SanPhamJPanel spj;
    public SanPhamJDialog(JPanel parent, boolean modal) {
        initComponents();
        spj=(SanPhamJPanel) parent;
        setLocationRelativeTo(null);
        fillTable(spsv.getAll());
    ...
    public void fillTable(List<SanPham> listSp) {
        ...
        for (SanPham sp : listSp) {
            i++;
            model.addRow(new Object[]{i, sp.getMaSanPham(), sp.getTenSanPham()});
        }
    }

    void showData(int index) {
        SanPham sp = spsv.getAll().get(index);
    ...
    private SanPham updateForm() {
        ...
        return new SanPham(txtTen.getText(), toDay, Auth.idNhanVien());
    }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (sp != null) {
            ...
            if (confirm == 0) {
                if (spsv.addSanPham(sp) > 0) {
                    fillTable(spsv.getAll());
                    spj.fillComboBoxSanPham();
                    clearForm();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SanPhamJDialog dialog = new SanPhamJDialog(new javax.swing.JPanel(), true);
